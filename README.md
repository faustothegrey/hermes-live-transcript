...
- Tab **Backlog** che legge il backlog corrente da AgentTalk, mostra l'endpoint API configurato, conteggi per stato, warnings e item, e si aggiorna ogni 30s quando e attiva
